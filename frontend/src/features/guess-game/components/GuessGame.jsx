  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center gap-4 rounded-[22px] bg-[#fef3c7] px-[18px] py-4">
        ...
        <p className="m-0 font-comic text-xl font-bold text-[#7c2d12]">{mascotLine(t, guess, result, isChecking)}</p>
      </div>
      ...
      <div className="flex flex-col gap-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <h2 className="m-0 font-comic text-2xl font-extrabold text-[#7c2d12]">{t('guess.step1Title')}</h2>
      ...
      <div className="flex flex-col gap-3.5">
        <div className="flex items-center gap-2.5">
          ...
          <h2 className="m-0 font-comic text-2xl font-extrabold text-[#7c2d12]">{t('guess.step2Title')}</h2>
        </div>
          ...
          {GUESSABLE_COUNTRIES.map((country) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-center font-comic text-base leading-tight">{tWord(country)}</span>
              </button>
            );
          })}
        </div>

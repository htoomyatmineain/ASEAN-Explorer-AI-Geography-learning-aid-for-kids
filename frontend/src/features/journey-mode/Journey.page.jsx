...
// Dedicated page for Journey Mode (route is `bare`, so this owns the whole
// screen: background, header and back button) — mirrors the Neighbor Quiz /
// Capital Match pages so all practice modes read as their own screens. Its
// URL (/journey) can also be opened directly in a new browser tab.
